  ...
  return (
    <SlideShell className="relative">
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24 w-full max-w-7xl mx-auto">
        ...
        >
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden transition-all duration-500 border border-zinc-800 shadow-2xl">
            <Image 
              src="/Javier.jpeg" 
              alt="Javier Rivero" 
              fill
